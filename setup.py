...
exec(open('outbreak_detector/version.py').read())

setup(
    name='outbreak_detector',
    ...
    url='https://github.com/phac-nml/outbreak_detector',
    license='GPLv3',
    author='James Robertson',
    ...
    package_dir={'outbreak_detector': 'outbreak_detector'},
    package_data={
        "": ["*.tsv","*.json"],
    },
    ...
    entry_points={
        'console_scripts': [
            'outbreak_detector=outbreak_detector.main:main',
        ],
    },
)